...
export class HandWritePage {
  ...
  drawed: KanjiVGMoji = SAMPLES.sample2;
  moji: KanjiVGMoji = kan;
  comparer: KanjiComparer;
  constructor(public navCtrl: NavController, public navParams: NavParams) {
    this.moji = kan.scale(2.7522);
  ...
  drawedData(): KanjiVGMojiData {
    var data: KanjiVGMojiData = {
      ...
      strokes: this.drawed.strokes.map(s => {
        const sd: KanjiVGStrokeData = { path: s.path };
        return sd;
      })
    };
    return data;
